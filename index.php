...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger py-4 sticky-top">
  <a class="navbar-brand" href="#">ONLINE GAS</a>
...
<h1 class='display-1 text-center'>Online Gas</h1>
<h1 class='display-4 text-center'>Instance Gas Booking <br>& </br>Deliver To Door Step</h1>
<h1 class='lead text-center mt-4'>A Dbms Micro Project</h1>
...
<div class="row mt-5" >
<div class="col-lg-12 col-md-12 col-sm-12 bg-dark text-white py-3 text-center">
Contact Us /Query/ Complaints
</div>
</div>
<div class="row my-5" id="contact">
<div class="col-lg-4 col-md-4 col-sm-12 text-center">
<span class="lead">Address :</span>S5 CSE SNMIMT
</div>
<div class="col-lg-4 col-md-4 col-sm-12 text-center">
<span class="lead">Call :</span>8137824878,9809031477,8547413038
</div>
<div class="col-lg-4 col-md-4 col-sm-12 text-center">
<span class="lead">Email :</span>onlinegas@gmail.com
</div>
</div>
...
<div class="row mt-5" >
<div class="col-lg-12 col-md-12 col-sm-12 bg-dark text-white py-3 text-center">
&copy; Created BY Roshan,Nahala,Sanjay.All Rights Reserved 
</div>
</div>
</div>
    <!-- Optional JavaScript -->
